...
var mapState = new Map();//Declaration de l carte de jeux
var mapStateCart = [];//Declaration de l carte de jeux
var taille
...
const jouerCase = (e) => {
  ...
  if (verifActionJouer(e.target.id)) {
    ...
    alert("Impossible de réalser un pareil coup")
  }
